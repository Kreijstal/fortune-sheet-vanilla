 ...
 * @param {ReturnType<typeof defaultContext>} ctx
 */
export class Canvas {
    ...
    drawRowHeader(scrollHeight, drawHeight, offsetTop) {
        ...
        for (let r = dataset_row_st; r <= dataset_row_ed; r += 1) {
            ...
            if (((_b = (_a = this.sheetCtx.hooks).beforeRenderRowHeaderCell) === null || _b === void 0 ? void 0 : _b.call(_a, `${r + 1}`, r, start_r + offsetTop + firstOffset, this.sheetCtx.rowHeaderWidth - 1, end_r - start_r + 1 + lastOffset - firstOffset, renderCtx)) === false) {
                continue;
            }
            if (((_d = (_c = this.sheetCtx.config) === null || _c === void 0 ? void 0 : _c.rowhidden) === null || _d === void 0 ? void 0 : _d[r]) == null) {
            ...
            if (((_f = (_e = this.sheetCtx.config) === null || _e === void 0 ? void 0 : _e.rowhidden) === null || _f === void 0 ? void 0 : _f[r - 1]) != null &&
                preEndR !== undefined) {
                renderCtx.beginPath();
            ...
            preEndR = end_r;
            (_h = (_g = this.sheetCtx.hooks).afterRenderRowHeaderCell) === null || _h === void 0 ? void 0 : _h.call(_g, `${r + 1}`, r, start_r + offsetTop + firstOffset, this.sheetCtx.rowHeaderWidth - 1, end_r - start_r + 1 + lastOffset - firstOffset, renderCtx);
        }
        renderCtx.restore();
        renderCtx.restore();
    }
    ...
    drawMain({ scrollWidth, scrollHeight, drawWidth, drawHeight, offsetLeft, offsetTop, columnOffsetCell, rowOffsetCell, clear, }) {
        ...
        const borderOffset = {};
        const bodrder05 = 0.5;
        (_b = (_a = this.sheetCtx.hooks).beforeRenderCellArea) === null || _b === void 0 ? void 0 : _b.call(_a, flowdata, renderCtx);
        for (let r = rowStart; r <= rowEnd; r += 1) {
            ...
            for (let c = colStart; c <= colEnd; c += 1) {
                ...
                if (((_f = (_e = this.sheetCtx.config) === null || _e === void 0 ? void 0 : _e.colhidden) === null || _f === void 0 ? void 0 : _f[c]) != null) {
                    continue;
                }
                let firstcolumnlen = this.sheetCtx.defaultcollen;
                if ((_h = (_g = this.sheetCtx.config) === null || _g === void 0 ? void 0 : _g.columnlen) === null || _h === void 0 ? void 0 : _h[c]) {
                    firstcolumnlen = this.sheetCtx.config.columnlen[c];
                }
                if ((_j = flowdata === null || flowdata === void 0 ? void 0 : flowdata[r]) === null || _j === void 0 ? void 0 : _j[c]) {
        ...
        for (let m = 0; m < mcArr.length; m += 1) {
            ...
            if (!((_k = mainCell === null || mainCell === void 0 ? void 0 : mainCell.mc) === null || _k === void 0 ? void 0 : _k.rs) || !((_l = mainCell.mc) === null || _l === void 0 ? void 0 : _l.cs)) {
                continue;
            }
            if (c === 0) {
                startX = -scrollWidth;
        ...
        if (((_p = (_o = (_m = this.sheetCtx.config) === null || _m === void 0 ? void 0 : _m.borderInfo) === null || _o === void 0 ? void 0 : _o.length) !== null && _p !== void 0 ? _p : 0) > 0) {
            ...
            Object.keys(borderInfoCompute).forEach((x) => {
                ...
                if (borderOffset[`${bdRow}_${bdCol}`]) {
                    ...
                    if (borderSlash &&
                        ...
                        const mergeCell = mergeMap === null || mergeMap === void 0 ? void 0 : mergeMap[`${bdRow}_${bdCol}`];
                        let mergeCellEndX;
                        let mergeCellEndY;
                        if (mergeCell) {
                        ...
                        borderSlashRender(borderSlash.style, borderSlash.color, startY, startX, mergeCellEndY !== null && mergeCellEndY !== void 0 ? mergeCellEndY : endY, mergeCellEndX !== null && mergeCellEndX !== void 0 ? mergeCellEndX : endX, offsetLeft, offsetTop, renderCtx);
                    }
    ...
    cellRender(r, c, startY, startX, endY, endX, value, renderCtx, afCompute, cfCompute, offsetLeft, offsetTop, dynamicArrayCompute, cellOverflowMap, colStart, colEnd, scrollHeight, scrollWidth, bodrder05, isMerge = false) {
        ...
        if ((dataVerification === null || dataVerification === void 0 ? void 0 : dataVerification[`${r}_${c}`]) &&
            !validateCellData(this.sheetCtx, dataVerification[`${r}_${c}`], value)) {
            const dv_w = 5 * this.sheetCtx.zoomRatio;
            const dv_h = 5 * this.sheetCtx.zoomRatio;
            renderCtx.beginPath();
        ...
        if ((cell === null || cell === void 0 ? void 0 : cell.qp) === 1 && isRealNum(cell === null || cell === void 0 ? void 0 : cell.v)) {
            ...
            const ps_h = 6 * this.sheetCtx.zoomRatio;
            renderCtx.beginPath();
        ...
        else if (((_c = dataVerification === null || dataVerification === void 0 ? void 0 : dataVerification[`${r}_${c}`]) === null || _c === void 0 ? void 0 : _c.type) === "checkbox") {
    ...
    cellOverflowRender(r, c, stc, edc, renderCtx, scrollHeight, scrollWidth, offsetLeft, offsetTop, afCompute, cfCompute) {
        let startY;
        if (r === 0) {
            startY = -scrollHeight - 1;
        }
...
/**
 * @typedef {import("./context.js").defaultContext} defaultContext
 */
