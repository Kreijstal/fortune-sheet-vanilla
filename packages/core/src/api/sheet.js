...
export { getSheet };
/**
 * @param {Context} draftCtx
 * @param {number} index
 * @param {Sheet} newData
 * @returns {CellMatrix | null}
 */
export function initSheetData(draftCtx, index, newData) {
    ...
    let lastRowNum = ((_a = lastRow === null || lastRow === void 0 ? void 0 : lastRow.r) !== null && _a !== void 0 ? _a : 0) + 1;
    let lastColNum = ((_b = lastCol === null || lastCol === void 0 ? void 0 : lastCol.c) !== null && _b !== void 0 ? _b : 0) + 1;
    ...
    if (lastRowNum && lastColNum) {
        ...
        celldata === null || celldata === void 0 ? void 0 : celldata.forEach((d) => {
...
export function hideSheet(ctx, sheetId) {
    ...
    const shownSheets = ctx.luckysheetfile.filter((sheet) => _.isUndefined(sheet.hide) || (sheet === null || sheet === void 0 ? void 0 : sheet.hide) !== 1);
...
function calculateSheetFromula(ctx, id, range) {
    ...
    for (let _r = 0; _r < rowCount; _r += 1) {
        for (let _c = 0; _c < columnCount; _c += 1) {
            ...
            const result = execfunction(ctx, (_b = ctx.luckysheetfile[index].data[r][c]) === null || _b === void 0 ? void 0 : _b.f, r, c, id);
...
/**
 * @typedef {import("./api/common.js").getSheet} getSheet
