...
export function setConditionRules(ctx, protection, generalDialog, conditionformat, rules) {
    ...
    if (conditionName === "greaterThan" ||
        ...
        if (rangeArr.length > 1) {
            const r1 = (_a = rangeArr[0]) === null || _a === void 0 ? void 0 : _a.row[0];
            const r2 = (_b = rangeArr[0]) === null || _b === void 0 ? void 0 : _b.row[1];
            const c1 = (_c = rangeArr[0]) === null || _c === void 0 ? void 0 : _c.column[0];
            const c2 = (_d = rangeArr[0]) === null || _d === void 0 ? void 0 : _d.column[1];
            if (r1 === r2 && c1 === c2) {
        ...
        if (rangeArr1.length === 1) {
            const r1 = (_g = rangeArr1[0]) === null || _g === void 0 ? void 0 : _g.row[0];
            const r2 = (_h = rangeArr1[0]) === null || _h === void 0 ? void 0 : _h.row[1];
            const c1 = (_j = rangeArr1[0]) === null || _j === void 0 ? void 0 : _j.column[0];
            const c2 = (_k = rangeArr1[0]) === null || _k === void 0 ? void 0 : _k.column[1];
            if (r1 === r2 && c1 === c2) {
                const d = getFlowdata(ctx);
                if (!d || _.isNil(r1) || _.isNil(c1))
                    return;
        ...
        if (rangeArr2.length === 1) {
            const r1 = (_o = rangeArr2[0]) === null || _o === void 0 ? void 0 : _o.row[0];
            const r2 = (_p = rangeArr2[0]) === null || _p === void 0 ? void 0 : _p.row[1];
            const c1 = (_q = rangeArr2[0]) === null || _q === void 0 ? void 0 : _q.column[0];
            const c2 = (_r = rangeArr2[0]) === null || _r === void 0 ? void 0 : _r.column[1];
            if (r1 === r2 && c1 === c2) {
                const d = getFlowdata(ctx);
                if (!d || _.isNil(r1) || _.isNil(c1))
                    return;
    ...
    const ruleArr = (_v = ctx.luckysheetfile[index].luckysheet_conditionformat_save) !== null && _v !== void 0 ? _v : [];
        ...
        for (let i = 0; i < ruleArr.length; i += 1) {
            ...
            if (type === "dataBar") {
                ...
                if (!_.isNil(max) && !_.isNil(min)) {
                    if (min < 0) {
                        const plusLen = Math.round((max / (max - min)) * 10) / 10;
                        const minusLen = Math.round((Math.abs(min) / (max - min)) * 10) / 10;
                        for (let s = 0; s < cellrange.length; s += 1) {
                            for (let r = cellrange[s].row[0]; r <= cellrange[s].row[1]; r += 1) {
                                for (let c = cellrange[s].column[0]; c <= cellrange[s].column[1]; c += 1) {
                                    if (_.isNil(d[r]) || _.isNil(d[r][c])) {
