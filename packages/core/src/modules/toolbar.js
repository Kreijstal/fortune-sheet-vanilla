        ...
        for (let r = row_st; r <= row_ed; r += 1) {
            ...
            for (let c = col_st; c <= col_ed; c += 1) {
                ...
                if (value && _.isPlainObject(value)) {
                    ...
                    const cellWidth = ((_a = cfg.columnlen) === null || _a === void 0 ? void 0 : _a[c]) ||
                    ...
                    if (attr === "fs" && canvas) {
                        ...
                        const currentRowHeight = ((_b = cfg.rowlen) === null || _b === void 0 ? void 0 : _b[r]) ||
...
export function handleClearFormat(ctx) {
    ...
    if (!flowdata)
        return;
    (_a = ctx.luckysheet_select_save) === null || _a === void 0 ? void 0 : _a.every((selection) => {
...
export function handleFreeze(ctx, type) {
    ...
    const firstSelection = (_a = ctx.luckysheet_select_save) === null || _a === void 0 ? void 0 : _a[0];
    if (!firstSelection)
        return;
    let { row_focus, column_focus } = firstSelection;
    if (row_focus == null || column_focus == null)
        return;
    const m = (_b = ctx.config.merge) === null || _b === void 0 ? void 0 : _b[`${row_focus}_${column_focus}`];
    if (m) {
...
export function handleLink(ctx) {
    ...
    if (!allowEdit)
        return;
    const selection = (_a = ctx.luckysheet_select_save) === null || _a === void 0 ? void 0 : _a[0];
    const flowdata = getFlowdata(ctx);
...
const selectedMap = {
    bold: (cell) => (cell === null || cell === void 0 ? void 0 : cell.bl) === 1,
    italic: (cell) => (cell === null || cell === void 0 ? void 0 : cell.it) === 1,
    "strike-through": (cell) => (cell === null || cell === void 0 ? void 0 : cell.cl) === 1,
    underline: (cell) => (cell === null || cell === void 0 ? void 0 : cell.un) === 1,
};
/**
 * @param {string} name
 * @returns {ToolbarItemClickHandler}
 */
...
/**
 * @param {string} name
 * @returns {ToolbarItemSelectedFunc}
 */
...
/**
 * @typedef {Object} ToolbarItemClickHandler
 */

/**
 * @typedef {Object} ToolbarItemSelectedFunc
 */
