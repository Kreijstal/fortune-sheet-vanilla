...
/**
 * @param {Rect} { width, height, top, left }
...
function fillExtendNumber(data, len, step) {
    ...
    for (let i = 1; i <= len; i += 1) {
        const index = (i - 1) % data.length;
        const d = _.cloneDeep(data[index]);
        let last = (_a = data[data.length - 1]) === null || _a === void 0 ? void 0 : _a.m;
        if (d != null && last != null) {
            last = `${last}`;
...
function fillChnWeek(data, len, step) {
    ...
    for (let i = 1; i <= len; i += 1) {
        ...
        const d = _.cloneDeep(data[index]);
        let num;
        const m = (_a = data[data.length - 1]) === null || _a === void 0 ? void 0 : _a.m;
        if (m != null && d != null) {
            if (m === "日") {
                num = 7 + step * i;
            }
    ...
    if (type === "0" || data.length === 1) {
        ...
        if (dataType === "number") {
            ...
            for (let i = 0; i < data.length; i += 1) {
                const txt = (_a = data[i]) === null || _a === void 0 ? void 0 : _a.m;
            ...
            if (_judgeDate[0] && _judgeDate[3]) {
                const step = dayjs((_b = data[1]) === null || _b === void 0 ? void 0 : _b.m).diff(dayjs((_c = data[0]) === null || _c === void 0 ? void 0 : _c.m), "months");
                applyData = fillMonths(data, len, step);
            }
            else if (!_judgeDate[0] && _judgeDate[2]) {
                const step = dayjs((_d = data[1]) === null || _d === void 0 ? void 0 : _d.m).diff(dayjs((_e = data[0]) === null || _e === void 0 ? void 0 : _e.m), "days");
            ...
            let weekIndex = 0;
            for (let i = 0; i < data.length; i += 1) {
                let m = (_h = data[i]) === null || _h === void 0 ? void 0 : _h.m;
                if (m != null) {
                    m = `${m}`;
                    if (m === "日") {
                        if (i === 0) {
            ...
            let weekIndex = 0;
            for (let i = 0; i < data.length; i += 1) {
                let m = (_j = data[i]) === null || _j === void 0 ? void 0 : _j.m;
                if (m != null) {
                    m = `${m}`;
            ...
            let weekIndex = 0;
            for (let i = 0; i < data.length; i += 1) {
                let m = (_k = data[i]) === null || _k === void 0 ? void 0 : _k.m;
                if (m != null) {
                    m = `${m}`;
                    const lastTxt = m.slice(m.length - 1, 1);
                    if (m === "星期日") {
        ...
        if (data.length === 2) {
            ...
            const step = dayjs((_l = data[1]) === null || _l === void 0 ? void 0 : _l.m).diff(dayjs((_m = data[0]) === null || _m === void 0 ? void 0 : _m.m), "days");
            applyData = fillDays(data, len, step);
        }
        else {
            if (direction === "up" || direction === "left") {
            ...
            const _judgeDate = judgeDate(data);
            if (_judgeDate[0] && _judgeDate[3]) {
                const step = dayjs((_o = data[1]) === null || _o === void 0 ? void 0 : _o.m).diff(dayjs((_p = data[0]) === null || _p === void 0 ? void 0 : _p.m), "months");
                applyData = fillMonths(data, len, step);
            }
            else if (!_judgeDate[0] && _judgeDate[2]) {
                const step = dayjs((_q = data[1]) === null || _q === void 0 ? void 0 : _q.m).diff(dayjs((_r = data[0]) === null || _r === void 0 ? void 0 : _r.m), "days");
                applyData = fillDays(data, len, step);
            }
            else {
                applyData = fillCopy(data, len);
        ...
        if (data.length === 2) {
            if (dayjs((_s = data[1]) === null || _s === void 0 ? void 0 : _s.m).date() === dayjs((_t = data[0]) === null || _t === void 0 ? void 0 : _t.m).date() &&
                ...
                const step = dayjs((_w = data[1]) === null || _w === void 0 ? void 0 : _w.m).diff(dayjs((_x = data[0]) === null || _x === void 0 ? void 0 : _x.m), "months");
                for (let i = 1; i <= len; i += 1) {
                    const index = (i - 1) % data.length;
                    const d = _.cloneDeep(data[index]);
                    const last = (_y = data[data.length - 1]) === null || _y === void 0 ? void 0 : _y.m;
                    if (d != null && last != null) {
            ...
            if (_judgeDate[0] && _judgeDate[3]) {
                ...
                const step = dayjs((_4 = data[1]) === null || _4 === void 0 ? void 0 : _4.m).diff(dayjs((_5 = data[0]) === null || _5 === void 0 ? void 0 : _5.m), "months");
                for (let i = 1; i <= len; i += 1) {
                    const index = (i - 1) % data.length;
                    const d = _.cloneDeep(data[index]);
                    const last = (_6 = data[data.length - 1]) === null || _6 === void 0 ? void 0 : _6.m;
                    if (d != null) {
                        const day = dayjs(last)
                            .add(step * i, "months")
                            .day();
        ...
        if (data.length === 2) {
            if (dayjs((_12 = data[1]) === null || _12 === void 0 ? void 0 : _12.m).date() === dayjs((_13 = data[0]) === null || _13 === void 0 ? void 0 : _13.m).date() &&
                ...
                const step = dayjs((_16 = data[1]) === null || _16 === void 0 ? void 0 : _16.m).diff(dayjs((_17 = data[0]) === null || _17 === void 0 ? void 0 : _17.m), "months");
                applyData = fillMonths(data, len, step);
            }
            else {
                let step_month;
            ...
            if (_judgeDate[0] && _judgeDate[3]) {
                ...
                const step = dayjs((_19 = data[1]) === null || _19 === void 0 ? void 0 : _19.m).diff(dayjs((_20 = data[0]) === null || _20 === void 0 ? void 0 : _20.m), "months");
                applyData = fillMonths(data, len, step);
            }
            else if (!_judgeDate[0] && _judgeDate[2]) {
                let step_month;
        ...
        if (data.length === 2) {
            if (dayjs((_22 = data[1]) === null || _22 === void 0 ? void 0 : _22.m).date() === dayjs((_23 = data[0]) === null || _23 === void 0 ? void 0 : _23.m).date() &&
                ...
                const step = dayjs((_28 = data[1]) === null || _28 === void 0 ? void 0 : _28.m).diff(dayjs((_29 = data[0]) === null || _29 === void 0 ? void 0 : _29.m), "years");
            ...
            if (_judgeDate[0] && _judgeDate[1] && _judgeDate[4]) {
                ...
                const step = dayjs((_31 = data[1]) === null || _31 === void 0 ? void 0 : _31.m).diff(dayjs((_32 = data[0]) === null || _32 === void 0 ? void 0 : _32.m), "years");
                applyData = fillYears(data, len, step);
            }
        ...
        const dataNumArr = [];
        for (let i = 0; i < data.length; i += 1) {
            let m = (_34 = data[i]) === null || _34 === void 0 ? void 0 : _34.m;
            if (m != null) {
                m = `${m}`;
                dataNumArr.push(chineseToNumber(m));
            }
...
export function updateDropCell(ctx) {
    ...
    const hiddenRows = new Set(Object.keys(((_a = file.config) === null || _a === void 0 ? void 0 : _a.rowhidden) || {}));
    const hiddenCols = new Set(Object.keys(((_b = file.config) === null || _b === void 0 ? void 0 : _b.colhidden) || {}));
                            ...
                            if (isRealNum(cell.v) &&
                                ...
                                if (cell.v === Infinity || cell.v === -Infinity) {
                                    ...
                                    if (cell.v.toString().indexOf("e") > -1) {
                                        ...
                                        let mask;
                                        if (((_c = cell.ct) === null || _c === void 0 ? void 0 : _c.fa) === "##0.00") {
        ...
        if (ctx.config.merge != null) {
            ...
            for (let r = last.row[0]; r <= last.row[1]; r += 1) {
                for (let c = last.column[0]; c <= last.column[1]; c += 1) {
                    const cell = (_b = flowdata[r]) === null || _b === void 0 ? void 0 : _b[c];
            ...
            for (let r = row_s; r <= row_e; r += 1) {
                for (let c = col_s; c <= col_e; c += 1) {
                    const cell = (_c = flowdata[r]) === null || _c === void 0 ? void 0 : _c[c];
                    if (cell != null && cell.mc != null) {
                        HasMC = true;
                        break;
                    }
