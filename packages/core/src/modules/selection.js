...
export function scrollToHighlightCell(ctx, r, c) {
    ...
    if (!sheet)
        return;
    const frozen = sheet === null || sheet === void 0 ? void 0 : sheet.frozen;
    if (r >= 0) {
        const row_focus = ((_b = (_a = sheet === null || sheet === void 0 ? void 0 : sheet.frozen) === null || _a === void 0 ? void 0 : _a.range) === null || _b === void 0 ? void 0 : _b.row_focus) || 0;
    ...
    if (c >= 0) {
        const column_focus = ((_d = (_c = sheet === null || sheet === void 0 ? void 0 : sheet.frozen) === null || _c === void 0 ? void 0 : _c.range) === null || _d === void 0 ? void 0 : _d.column_focus) || 0;
...
export function pasteHandlerOfPaintModel(ctx, copyRange) {
    ...
    const timesH = Math.ceil((maxh - minh + 1) / copyh);
    const timesC = Math.ceil((maxc - minc + 1) / copyc);
    const flowdata = getFlowdata(ctx);
    if (flowdata == null)
        return;
...
export function colHasMerged(ctx, c, r1, r2) {
    ...
    for (let r = r1; r <= r2; r += 1) {
        const cell = (_a = flowData[r]) === null || _a === void 0 ? void 0 : _a[c];
...
export function rangeValueToHtml(ctx, sheetId, ranges) {
    ...
    const rowIndexArr = [];
    const colIndexArr = [];
    for (let s = 0; s < ((_a = ranges === null || ranges === void 0 ? void 0 : ranges.length) !== null && _a !== void 0 ? _a : 0); s += 1) {
    ...
    for (let i = 0; i < rowIndexArr.length; i += 1) {
        ...
        for (let j = 0; j < colIndexArr.length; j += 1) {
            ...
            const cell = (_c = d[r]) === null || _c === void 0 ? void 0 : _c[c];
            if (cell != null) {
                let style = "";
                let span = "";
                if (r === rowIndexArr[0]) {
...
export function copy(ctx) {
    ...
    let HasMC = false;
    for (let s = 0; s < ((_b = (_a = ctx.luckysheet_select_save) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0); s += 1) {
        ...
        for (let copyR = r1; copyR <= r2; copyR += 1) {
            ...
            for (let copyC = c1; copyC <= c2; copyC += 1) {
                ...
                const cell = (_c = flowdata === null || flowdata === void 0 ? void 0 : flowdata[copyR]) === null || _c === void 0 ? void 0 : _c[copyC];
    ...
    if (selection && !_.isEmpty(selection)) {
        ...
        for (let s = 0; s < selection.length; s += 1) {
            ...
            if (sheetIndex !== null && ctx.luckysheetfile[sheetIndex].data) {
                const { data = [] } = (_a = ctx.luckysheetfile[sheetIndex]) !== null && _a !== void 0 ? _a : {};
                for (let r = r1; r <= r2; r += 1) {
                    for (let c = c1; c <= c2; c += 1) {
                        if (!data[r])
                            data[r] = [];
...
export function fixRowStyleOverflowInFreeze(ctx, r1, r2, freeze) {
    ...
    const ret = {};
    const { scrollTop } = ctx;
    const freezenhorizontaldata = (_a = freeze.horizontal) === null || _a === void 0 ? void 0 : _a.freezenhorizontaldata;
    let rangeshow = true;
...
export function fixColumnStyleOverflowInFreeze(ctx, c1, c2, freeze) {
    ...
    const freezenverticaldata = (_a = freeze.vertical) === null || _a === void 0 ? void 0 : _a.freezenverticaldata;
    let rangeshow = true;
        ...
        for (let r = 0; r < data.length; r += 1) {
            for (let c = 0; c < data[0].length; c += 1) {
                if (r >= data.length || c >= data[0].length)
                    break;
                const ct = (_b = (_a = data[r][c]) === null || _a === void 0 ? void 0 : _a.ct) === null || _b === void 0 ? void 0 : _b.t;
                const value = (_c = data[r][c]) === null || _c === void 0 ? void 0 : _c.m;
                if (ct === "n" ||
