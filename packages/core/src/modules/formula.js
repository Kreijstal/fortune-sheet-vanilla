...
export class FormulaCache {
    constructor() {
        ...
        this.parser.on("callCellValue", (cellCoord, options, done) => {
            ...
            const cell = ((_a = context === null || context === void 0 ? void 0 : context.formulaCache.execFunctionGlobalData) === null || _a === void 0 ? void 0 : _a[`${cellCoord.row.index}_${cellCoord.column.index}_${id}`]) || ((_b = flowdata === null || flowdata === void 0 ? void 0 : flowdata[cellCoord.row.index]) === null || _b === void 0 ? void 0 : _b[cellCoord.column.index]);
        ...
        this.parser.on("callRangeValue", (startCellCoord, endCellCoord, options, done) => {
            ...
            for (let row = startRow; row <= endRow; row += 1) {
                ...
                for (let col = startCol; col <= endCol; col += 1) {
                    const cell = ((_c = context === null || context === void 0 ? void 0 : context.formulaCache.execFunctionGlobalData) === null || _c === void 0 ? void 0 : _c[`${row}_${col}_${id}`]) || ((_d = flowdata === null || flowdata === void 0 ? void 0 : flowdata[row]) === null || _d === void 0 ? void 0 : _d[col]);
                    const v = that.tryGetCellAsNumber(cell);
                    colFragment.push(v);
                }
    ...
    tryGetCellAsNumber(cell) {
        ...
        if (((_a = cell === null || cell === void 0 ? void 0 : cell.ct) === null || _a === void 0 ? void 0 : _a.t) === "n") {
            const n = Number(cell === null || cell === void 0 ? void 0 : cell.v);
 ...
 * @param {number | null} c
 * @param {string} id
 * @param {any} dynamicArray_compute
 * @param {any} cellRangeFunction
 * @returns {string}
 */
        ...
        if (i === funcstack.length - 1) {
            ...
            if (iscelldata(str_nb) && str_nb.substring(0, 1) !== ":") {
                ...
                if (regx.test(str) &&
                    ...
                    const arraytxt = (_a = regx.exec(str)) === null || _a === void 0 ? void 0 : _a[0];
...
/**
 * @param {Context} ctx
 * @param {number} origin_r
 * @param {number} origin_c
 * @param {any} value
 * @param {string} [id]
 * @param {any} [data]
...
/**
 * @param {Context} ctx
 * @param {string} inputInnerHtmlStr
 * @param {number} [ignoreRangeIndex]
 */
...
export function getrangeseleciton() {
    ...
    if (anchorElement.id === "luckysheet-rich-text-editor" ||
        ...
        let txt = _.trim((_c = _.last(anchorElement.querySelectorAll("span"))) === null || _c === void 0 ? void 0 : _c.innerText);
    ...
    if (((_d = anchorNode === null || anchorNode === void 0 ? void 0 : anchorNode.parentElement) === null || _d === void 0 ? void 0 : _d.id) === "luckysheet-rich-text-editor" ||
        ...
        anchorOffset === 0) {
        const newAnchorNode = anchorOffset === 0 ? anchorNode === null || anchorNode === void 0 ? void 0 : anchorNode.parentNode : anchorNode;
...
function helpFunctionExe($editer, currSelection, ctx) {
    ...
    const currentIndex = _.indexOf((_a = currSelection.parentNode) === null || _a === void 0 ? void 0 : _a.childNodes, currSelection);
    let i = currentIndex;
    if ($prev == null) {
        return null;
    }
...
/**
 * @param {Context} ctx
 * @param {HTMLDivElement | null | undefined} $copyTo
 * @param {HTMLDivElement} $editor
 * @param {number} kcode
 * @param {string} [preText]
 * @param {boolean} [refreshRangeSelect]
 */
export function handleFormulaInput(ctx, $copyTo, $editor, kcode, preText, refreshRangeSelect = true) {
    var _a, _b, _c, _d, _e, _f;
    let value1;
    const value1txt = preText !== null && preText !== void 0 ? preText : $editor.innerText;
...
export function israngeseleciton(ctx, istooltip) {
    ...
    if (((_a = anchor === null || anchor === void 0 ? void 0 : anchor.parentNode) === null || _a === void 0 ? void 0 : _a.nodeName.toLowerCase()) === "span" &&
        ...
        anchorElement.id === "luckysheet-functionbox-cell") {
        let txt = _.trim((_b = _.last(anchorElement.querySelectorAll("span"))) === null || _b === void 0 ? void 0 : _b.innerText);
...
export function rangeSetValue(ctx, cellInput, selected, fxInput) {
    ...
    if (!israngeseleciton(ctx) &&
        ...
        if (refEle && refEle.parentNode) {
            const leftPar = (_b = document.getElementsByClassName("luckysheet-formula-text-lpar")) === null || _b === void 0 ? void 0 : _b[0];
