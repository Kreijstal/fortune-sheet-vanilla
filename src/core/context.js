 ...
 * @returns {import("./types").CellMatrix}
 */
 ...
 * @param {function(): string} generateSheetId
 */
...
export function initSheetIndex(ctx) {
  ...
  ctx.currentSheetId = [...shownSheets].sort((a, b) => a.order - b.order)[0].id;
 ...
 * @property {Array<Sheet>} luckysheetfile
 * @property {number} defaultcolumnNum
 * @property {number} defaultrowNum
 * @property {number} addDefaultRows
 * @property {boolean} fullscreenmode
 * @property {number} devicePixelRatio
 * @property {Array<CommentBox>} [commentBoxes]
 * @property {CommentBox} [editingCommentBox]
 * @property {CommentBox} [hoveredCommentBox]
 * @property {Array<Image>} [insertedImgs]
 * @property {Image} [editingInsertedImgs]
 * @property {string} [activeImg]
 * @property {Array<Presence>} [presences]
 * @property {boolean} [showSearch]
 * @property {boolean} [showReplace]
 * @property {LinkCardProps} [linkCard]
 * @property {RangeDialogProps} [rangeDialog]
 * @property {string} [warnDialog]
 ...
 * @property {boolean} [dataVerificationDropDownList]
 * @property {ConditionRulesProps} conditionRules
 * @property {{
        x?: number;
        y?: number;
        headerMenu?: boolean;
 ...
 * @property {{
        ...
        y?: number;
        sheet?: Sheet;
        onRename?: () => void} sheetTabContextMenu
 */

/**
 * @typedef {Object} MutableRefObject
 */

/**
 * @typedef {Object} RefValues
 */

/**
 * @typedef {import("./index.js").SheetConfig} SheetConfig
 * @typedef {import("./modules.js").FormulaCache} FormulaCache
