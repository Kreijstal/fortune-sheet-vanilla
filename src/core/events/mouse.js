...
} from './../modules/hyperlink.js';
import {
  onSearchDialogMove,
  onSearchDialogMoveEnd,
} from './../modules/searchReplace.js';
...
function mouseRender(
  ...
  if (ctx.luckysheet_select_status) {
    ...
    // 判断当前是不去选择整行
    const isMaxColumn =
      ctx.luckysheet_select_save[ctx.luckysheet_select_save.length - 1].column;
